...
var app = script.addFileParameter("App exe","path to application to launch", "");
...
function init()
{
	...
	app.launchFile();
	//oShell.Exec("C:\\Users\\Gamgie\\Documents\\Gamgie\\Unity\\Propagason\\Build\\Propagason.exe");
}
